...
void main() {
  late MobileBankingPaymentMethodSelectorController controller;
  ...
  group('MobileBankingPaymentMethodSelectorController', () {
    test('CreateSource - success with selected payment method', () async {
      ...
      controller = MobileBankingPaymentMethodSelectorController(
      ...
      var changes = <MobileBankingPaymentMethodSelectorState>[];
